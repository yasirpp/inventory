...
<link rel="stylesheet" href="{{asset('theme/css/maruti-style.css')}}" />
<link rel="stylesheet" href="{{asset('theme/css/maruti-media.css')}}" class="skin-color" />
</head>
<body>
...
<script src="{{asset('theme/js/maruti.js')}}"></script> 
<script src="{{asset('theme/js/maruti.dashboard.js')}}"></script> 
<script src="{{asset('theme/js/maruti.chat.js')}}"></script> 
